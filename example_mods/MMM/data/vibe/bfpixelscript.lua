...
idle_xml_name = 'BF IDLE'
left_xml_name = 'BF LEFT NOTE'
down_xml_name = 'BF DOWN NOTE'
up_xml_name = 'BF UP NOTE'
right_xml_name = 'BF RIGHT NOTE'
...
name_of_character_xml = 'bfPixel'
name_of_character = 'bf-pixel'
name_of_notetype = 'bfpixel'
