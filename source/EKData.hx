...
class EKData {
    ...
    public static var lesserScale:Array<Array<Float>> = [
        //one strum, two, three, so on
        [1, 1, 1, 1, 1, 1, 1], //1k
        [1, 1, 1, 1, 1, 1, 1], //2k
        [1, 1, 1, 1, 1, 1, 1], //3k
        [1, 1, 1, 1, 1, 1, 1], //4k
        [1, 1, 1, 0.9, 0.85, 0.83, 0.8], //5k
        [1, 1, 1, 0.88, 0.84, 0.82, 0.79], //6k
        [1, 1, 1, 0.86, 0.82, 0.8, 0.77], //7k
        [1, 1, 1, 0.84, 0.80, 0.78, 0.76], //8k
        [1, 1, 1, 0.82, 0.78, 0.76, 0.74], //9k
        [1, 1, 1, 0.81, 0.77, 0.75, 0.73], //10k
        [1, 1, 1, 0.8, 0.76, 0.74, 0.72], //11k
        [1, 1, 1, 0.79, 0.75, 0.73, 0.71], //12k
        [1, 1, 1, 0.78, 0.74, 0.72, 0.7], //13k
        [1, 1, 1, 0.77, 0.73, 0.71, 0.69], //14k
        [1, 1, 1, 0.76, 0.72, 0.7, 0.68], //15k
        [1, 1, 1, 0.755, 0.725, 0.715, 0.705], //16k
        [1, 1, 1, 0.75, 0.72, 0.71, 0.7], //17k
        [1, 1, 1, 0.745, 0.715, 0.705, 0.695] //18k
    ];
