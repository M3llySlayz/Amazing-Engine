...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Call Me The Hitman",			"Beat Week 3 on Hard with no Misses (unlocks a new character in Character Select).",				'week3_nomiss',			false],
		...
		["God Effing Damn It!",			"Beat Week 7 on Hard with no Misses (unlocks a new character in Character Select).",				'week7_nomiss',			false],
		...
		["Spice it Up",					"Install your first mod on Amazing Engine (unlocks a new character in Character Select)", 'modinstalled', false]
	];
