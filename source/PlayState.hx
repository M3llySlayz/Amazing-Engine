...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		laneunderlayOp = new FlxSprite(0, 0).makeGraphic(160 * (mania + 1), FlxG.height * 4, FlxColor.BLACK);
		laneunderlayOp.alpha = 0;
		add(laneunderlayOp);

		laneunderlay = new FlxSprite(0, 0).makeGraphic(160 * (mania + 1), FlxG.height * 4, FlxColor.BLACK);
	...
	override public function update(elapsed:Float)
	{
		...
		laneunderlay.makeGraphic(160 * (mania + 1), FlxG.height * 4, FlxColor.BLACK);
		laneunderlay.x = !playingAsOpponent ? playerStrums.members[0].x - 25 : opponentStrums.members[0].x - 25;
		laneunderlay.screenCenter(Y);
		laneunderlayOp.makeGraphic(160 * (mania + 1), FlxG.height * 4, FlxColor.BLACK);
